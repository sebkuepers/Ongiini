...
Outputs:
  ...
  ongiini/knowledge/product.md       — baked into the webhook image,
...
WEBHOOK_OUT = ROOT / "ongiini" / "knowledge" / "product.md"
...
def build_markdown(
    ...
    lines.append(
        ...
        f"edit the source HTML and re-run `scripts/build_product_knowledge.py`. "
        ...
        for path in (WEBHOOK_OUT, WEBSITE_OUT):
            ...
            if existing != new_md:
                print(
                    ...
                    f"regenerated. Run `python3 scripts/build_product_knowledge.py` "
